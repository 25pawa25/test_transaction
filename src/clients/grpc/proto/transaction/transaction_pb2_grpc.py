...
class TransactionStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateUserBalance = channel.unary_unary(
            '/transaction.Transaction/CreateUserBalance',
            request_serializer=transaction__pb2.CreateUserBalanceRequest.SerializeToString,
            response_deserializer=transaction__pb2.CreateUserBalanceResponse.FromString,
...
def add_TransactionServicer_to_server(servicer, server):
    rpc_method_handlers = {
        'CreateUserBalance': grpc.unary_unary_rpc_method_handler(
            ...
            request_deserializer=transaction__pb2.CreateUserBalanceRequest.FromString,
            response_serializer=transaction__pb2.CreateUserBalanceResponse.SerializeToString,
        ),
    }
...
class Transaction(object):
    ...
    def CreateUserBalance(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/transaction.Transaction/CreateUserBalance',
            transaction__pb2.CreateUserBalanceRequest.SerializeToString,
            transaction__pb2.CreateUserBalanceResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
